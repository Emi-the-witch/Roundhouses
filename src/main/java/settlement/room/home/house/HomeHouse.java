...
import init.type.HOMET;
import settlement.entity.ENTITY;
import settlement.entity.humanoid.Humanoid;
import settlement.main.SETT;
import settlement.room.home.HOME;
import settlement.room.home.HomeSettings;
...
public final class HomeHouse extends RoomWrap implements HOME{
    ...
    HomeHouse useAndReserve(int tx, int ty){
        ...
        if (this.it != it | super.init(r, tx, ty)) {
            ...
            // sets valid to usable tiles of the house
            int t = 0, i = 0;
            ...
            // Resets valid to [1:valid.length]
            //for (i = 0; i < valid.length; i++)
            //    valid[i] = i;


            //for (; i < valid.length; i++, t++)
            //    valid[i] = t;
    ...
    HomeHouse create() {
        ...
        SETT.ROOMS().extraBit.set(service, 1);
        add();
